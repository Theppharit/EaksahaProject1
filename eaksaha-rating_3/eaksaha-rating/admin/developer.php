    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background:
                radial-gradient(900px 460px at 100% 0%, rgba(16,185,129,0.10), transparent 55%),
                radial-gradient(900px 520px at 0% 100%, rgba(14,165,233,0.10), transparent 55%),
                #F2F9FE;
        ...
        .hero {
            ...
            background: linear-gradient(140deg, #075985 0%, #0284C7 38%, #0EA5E9 62%, #10B981 100%);
        ...
        .hero-orb-1 { width: 340px; height: 340px; background: #67E8F9; top: -100px; right: -70px; animation: orb-drift 9s ease-in-out infinite alternate; }
        .hero-orb-2 { width: 260px; height: 260px; background: #6EE7B7; bottom: -40px; left: -60px; animation: orb-drift 11s ease-in-out infinite alternate-reverse; }
        @keyframes orb-drift {
        ...
        .hero h1 .grad {
            background: linear-gradient(90deg, #A5F3FC, #D2FBE8);
        ...
        .section-pill {
            ...
            white-space: nowrap; box-shadow: 0 6px 16px -6px rgba(14,165,233,0.5);
        }
        ...
        .dev-card {
            ...
            background: linear-gradient(135deg, rgba(14,165,233,0.55), rgba(16,185,129,0.55));
            max-width: 440px; width: 100%;
            transition: transform 0.25s, box-shadow 0.25s;
        }
        .dev-card:hover { transform: translateY(-6px); box-shadow: 0 26px 50px -20px rgba(2,132,199,0.45); }
        .dev-card-inner {
        ...
        .dev-ring {
            ...
            background: conic-gradient(var(--accent), var(--mint), #67E8F9, var(--accent));
        ...
        .dev-avatar {
            ...
            background: linear-gradient(135deg, #E8F5FC, #E7FBF3);
        ...
        .cp-icon {
            width: 25px; height: 25px; border-radius: 8px; background: #F1F7FC;
        ...
        .tech-chip {
            ...
            box-shadow: 0 8px 20px -14px rgba(2,132,199,0.35);
            transition: transform 0.2s, box-shadow 0.2s, border-color 0.2s;
        }
        .tech-chip:hover {
            transform: translateY(-3px) scale(1.03);
            border-color: rgba(14,165,233,0.5);
            box-shadow: 0 14px 28px -12px rgba(2,132,199,0.4);
        }
        ...
        .sys-card {
            ...
            overflow: hidden; box-shadow: 0 16px 40px -22px rgba(2,132,199,0.4);
        }
        .sys-card-head {
            background: linear-gradient(90deg, #075985, var(--accent-deep) 45%, var(--mint) 100%);
        ...
        .sys-row { display: flex; align-items: center; padding: 15px 26px; font-size: 14px; gap: 16px; border-bottom: 1px solid #EDF4F9; }
        ...
        .page-footer {
            ...
            background: linear-gradient(135deg, #075985, #0284C7 55%, #059669);
        ...
        .footer-brand span { color: #D2FBE8; }
...
<header class="hero">
    ...
    <div class="hero-content">
        ...
        <div class="hero-stats">
            ...
            <div class="hero-stat"><div class="hs-num" data-count="<?= date('Y') + 543 ?>">0</div><div class="hs-label">ปีที่พัฒนา (พ.ศ.)</div></div>
        </div>
    </div>
    ...
    <div class="hero-wave">
        <svg viewBox="0 0 1440 70" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="display:block; width:100%; height:70px;">
            <path d="M0,42 C280,74 560,10 840,34 C1100,56 1300,28 1440,42 L1440,70 L0,70 Z" fill="#F2F9FE"/>
        </svg>
    </div>
</header>
