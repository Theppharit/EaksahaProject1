            ...
            <?php else: ?>
                <?php foreach ($brands as $b): ?>
                    <tr>
                        ...
                        <td><span style="display:inline-block;width:22px;height:22px;border-radius:6px;border:1px solid #DCE9F2;vertical-align:middle;background:<?= htmlspecialchars($b['color']) ?>"></span> <?= htmlspecialchars($b['color']) ?></td>
