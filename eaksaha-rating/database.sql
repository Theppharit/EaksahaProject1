...
INSERT INTO `brands` (`name`, `code`, `color`, `sort_order`) VALUES
    ('DEEPAL',          'deepal',        '#E10600', 1),
    ('GEELY',           'geely',         '#1B6CA8', 2),
    ('AION',            'aion',          '#00A0A0', 3),
    ('GAC',             'gac',           '#C8102E', 4),
    ('OMODA & JAECOO',  'omoda_jaecoo',  '#0B7A5B', 5),
    ('WULING',          'wuling',        '#D4001A', 6),
    ('CHERY',           'chery',         '#B21F2D', 7),
    ('GWM',             'gwm',           '#E4002B', 8);
...
INSERT INTO `staff` (`code`, `name`, `position`, `brand_id`, `photo`) VALUES
    ...
    ('emp003', 'ธนกร วัฒนชัย',  'ที่ปรึกษาการขาย (Sales Consultant)', 6, NULL);
