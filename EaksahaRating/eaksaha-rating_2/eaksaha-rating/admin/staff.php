        ...
        <?php if ($editData): ?>
            ...
            <div class="field">
                ...
                <input type="text" id="code" value="<?= htmlspecialchars($editData['code']) ?>" readonly
                       style="background:#08080A; color:#6E6E76; cursor:not-allowed;">
        ...
        <div class="field">
            ...
            <div id="photoPreviewBox" style="margin-top:10px; <?= empty($editData['photo']) ? 'display:none;' : '' ?>">
                <img id="photoPreviewImg"
                     ...
                     alt="ตัวอย่างรูปภาพ"
                     style="width:110px;height:110px;border-radius:50%;object-fit:cover;border:2px solid #E10600;display:block;">
