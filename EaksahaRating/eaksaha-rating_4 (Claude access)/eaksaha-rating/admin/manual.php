...
// ดูคู่มือได้ทุกคน แต่อัปโหลด/ลบต้องเป็นผู้ดูแลระบบ
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    require_perm('manage_manual');
}
...
<?php if ($message): ?>
    <script>window.toast(<?= json_encode($messageType === 'error' ? 'error' : 'success', JSON_UNESCAPED_UNICODE) ?>,
                         <?= json_encode($messageType === 'error' ? 'ทำรายการไม่สำเร็จ' : 'สำเร็จ', JSON_UNESCAPED_UNICODE) ?>,
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="field">
            ...
            <div class="file-field">
                ...
                <label for="manual" class="file-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>เลือกไฟล์ PDF</label>
