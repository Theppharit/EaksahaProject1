...
require_perm('run_ai', true);

// ต้องเป็น POST เท่านั้น — คำสั่งนี้ยิง API จริงและมีค่าใช้จ่าย
// ไม่ควรถูกเรียกด้วยการเปิด URL เฉยๆ หรือถูก prefetch โดยเบราว์เซอร์
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    http_response_code(405);
    header('Content-Type: application/json; charset=utf-8');
    echo json_encode(['ok' => false, 'error' => 'ต้องส่งแบบ POST'], JSON_UNESCAPED_UNICODE);
    exit;
}
header('Content-Type: application/json; charset=utf-8');
