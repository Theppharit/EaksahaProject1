...
<header class="hero">
    ...
    <div class="hero-content">
        ...
        <h1>ทีมผู้อยู่เบื้องหลัง<br><span class="grad">ระบบ <?= htmlspecialchars(SYS_CODE) ?></span></h1>
        <p class="hero-sub">
...
<div class="page-wrap">
    ...
    <div class="sys-card reveal" style="--delay:100ms">
        ...
        <div class="sys-row"><span class="sys-label">ชื่อระบบ</span><span class="sys-value"><?= htmlspecialchars(SYS_NAME) ?> (<?= htmlspecialchars(SYS_CODE) ?>)</span></div>
